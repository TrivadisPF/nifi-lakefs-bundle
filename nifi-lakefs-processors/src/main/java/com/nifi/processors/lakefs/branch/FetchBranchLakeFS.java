...
@CapabilityDescription("""
                        Reads branch details for the lakefs repository and branch name provided as flow attributes.
                        """)
...
public class FetchBranchLakeFS extends AbstractLakefsProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        try {
            ...
            getLogger().error("Failed to get branch '{}' for repository {} due to {}", new Object[]{branchName, repository, e.getResponseBody()});
